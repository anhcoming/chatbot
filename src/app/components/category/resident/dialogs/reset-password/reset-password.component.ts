...
export class ResetPasswordComponent {
  ...
  onSubmit() {
    if(this.fPassword.invalid){
      ...
      reqData.currentPassword = this.lstResident.Password;
      reqData.passwordOld = this.lstResident.Password;
      ...
      this.commonService.changePassword(this.Idc, this.id , 4,reqData).subscribe(
        (res: ResApi) => {
