...
import { AppMessageResponse, AppStatusCode, CancelCardRequestProcessStatus, ChangeCardRequestProcessStatus, Gender, IsStatus, RelationshipOption, StatusPayment, StatusReceive, StorageData, TypePayment } from 'src/app/shared/constants/app.constants';
...
@Component({
  ...
  styleUrls: ['./card-cancel.component.scss']
})
