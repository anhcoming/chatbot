...
import { Paging, PagingInvoice, PagingInvoiceService } from '../viewModels/paging';
...
export class InvoiceContractTypeService {
 
  // public apiLink='https://localhost:7038/api/cms/InvContract/ContractType/';
  public apiLink=ApiConstant.InvoiceContractType;
